...
const Node <- immutable object Node builtin 0x1008
    const NodeType <- typeobject NodeType builtin 0x1608
        ...
        operation getDiscoveredNodes    -> [ NodeList ]
        operation getAllDiscoveredNodes -> [ NodeList ]
    ...
    export operation create [rd : Directory, mylnn : Integer] -> [ n : NodeType ]
        n <- object aNode builtin 0x1408
            ...
            export operation getDiscoveredNodes -> [ r : NodeList ]
                primitive "SYS" "GETDISCOVEREDNODES" 0 [ r ] <- [ ]
            end getDiscoveredNodes

            export operation getAllDiscoveredNodes -> [ r : NodeList ]
                primitive "SYS" "GETALLDISCOVEREDNODES" 0 [ r ] <- [ ]
            end getAllDiscoveredNodes
